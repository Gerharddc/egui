    ...
    unsafe fn new(
        ...
        */
        ...
        let context_attributes = {
            let mut context_attributes = glutin::context::ContextAttributesBuilder::new();
            if let Some(hook) = &native_options.context_builder {
                context_attributes = hook(context_attributes);
            }
            context_attributes
        }
